...
export function NotificationsDropdown() {
  ...
  const formatTimeAgo = (dateString: string) => {
    ...
    if (diffMins < 60)
      return t.notifications.minsAgo.replace("{m}", diffMins.toString());
    if (diffHours < 24)
      return t.notifications.hoursAgo.replace("{h}", diffHours.toString());
    return t.notifications.daysAgo.replace("{d}", diffDays.toString());
  };
