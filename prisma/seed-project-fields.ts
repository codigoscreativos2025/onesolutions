...
async function seedProjectFields() {
  ...
  const fields = [
    ...
    { projectTypeId: commons.id, fieldName: "paymentMethod", fieldLabel: "Metodo de pago", fieldType: "select", options: JSON.stringify(["Cash","Transferencia","Cheque","Tarjeta de credito","Foundation Finance","GoodLeap","Paneles solares"]), isRequired: true, order: 5 },
