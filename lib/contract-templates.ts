    ...
    <div class="page-container">
        ...
        <div class="footer-box">
            <div class="signature-container">
                ...
                <div>
                    <img src="/logo-company.png" class="footer-logo" alt="Icon" onerror="this.style.display='none'">
                </div>
            ...
            <div class="border-[3px] border-brand rounded-[2rem] border-b-0 rounded-b-none pt-[10px] pb-0 px-4 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-end gap-6 md:gap-0">
                    ...
                    <div class="flex justify-center px-6 -mt-8">
                        <img src="/logo-company.png" class="h-[120px] object-contain" alt="Icon" onerror="this.style.display='none'">
                    </div>
    ...
    <div class="header">
        <div class="logo-area">
            ...
            <div class="brand-text">
                ...
                <div class="brand-companies">COMPANIES</div>
            </div>
        </div>
