            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-outline-variant">
                  <th className="text-left py-2 px-3 font-semibold">{t.adminInvoices?.invoiceNumber || "Nro Factura"}</th>
                  <th className="text-left py-2 px-3 font-semibold">{t.adminInvoices?.date || "Fecha"}</th>
                  <th className="text-left py-2 px-3 font-semibold">{t.adminInvoices?.billTo || "Facturar A"}</th>
                  <th className="text-right py-2 px-3 font-semibold"> {t.adminInvoices?.total || "Total"} </th>
                  <th className="text-right py-2 px-3 font-semibold">{t.adminInvoices?.paid || "Pagado"}</th>
              ...
              <tbody>
                ...
                {filteredInvoices.length > 0 && (
                  <tr className="border-t-2 border-outline-variant font-bold bg-surface-container-low/50">
                    <td colSpan={3} className="py-3 px-3 text-right">{t.adminInvoices?.totals || "TOTALES:"}</td>
